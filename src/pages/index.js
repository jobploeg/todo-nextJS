...
export default function Home() {
    ...
    <>
        ...
        <div className={"flex justify-center"}>
            <ul className={"flex flex-col mt-14 justify-center"}>
                {todos.map((todo) => (
                    <div className={"flex"} key={todo.id}>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 hover:scale-110 mt-3 ml-10" onClick={() => completedTodoHandler(todo.id)}>
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>

                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 hover:scale-110 mt-3 ml-3" onClick={() => deleteTodoHandler(todo.id)} >
